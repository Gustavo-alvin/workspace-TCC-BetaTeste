...
function App() {
  return (/*
    <div classNameName='container'>
      <nav classNameName="navbar navbar-expand-lg menu">
        <div classNameName="container-fluid">
          ...
          <div classNameName="collapse navbar-collapse" id="navbarNav">
            <ul classNameName="navbar-nav">
              ...
              <li classNameName="nav-item">
                <a classNameName="nav-link" href="#">Produtos</a>
              </li>
              <li classNameName="nav-item">
                <a classNameName="nav-link" href="#">Quem Somos</a>
              </li>
              <li classNameName="nav-item">
                <a classNameName="nav-link" href="#">Fale Conosco</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <footer>
        <Link to={'/login'}
          classNameName='btn btn-sm btn-warning'>
          Acesso Restrito
        </Link>
      </footer>
    </div>
