...
<section className="container__terceario">
    <div className="textos3">
        ...
        <p id="teste" className='color-text'>É concedida permissão para baixar temporariamente uma cópia dos materiais (informações ou software) no site Charity Closet , apenas para visualização transitória pessoal e não comercial. Esta é a concessão de uma licença, não uma transferência de título e, sob esta licença, você não pode:</p>
            <ul>
                ...
                <li className='color-text'>tentar descompilar ou fazer engenharia reversa de qualquer software contido no site Charity Closet; </li>
    ...
    <div className="textos4">
        ...
        <p id="texto__4" className='color-text'>
            <ul>
                <li className='color-text'>Os materiais no site da Charity Closet são fornecidos 'como estão'. Charity Closet não oferece garantias, expressas ou implícitas, e, por este meio, isenta e nega todas as outras garantias, incluindo, sem limitação, garantias implícitas ou condições de comercialização, adequação a um fim específico ou não violação de propriedade intelectual ou outra violação de direitos.</li>
                <li className='color-text'>Além disso, o Charity Closet não garante ou faz qualquer representação relativa à precisão, aos resultados prováveis ​​ou à confiabilidade do uso dos materiais em seu site ou de outra forma relacionado a esses materiais ou em sites vinculados a este site.</li>
            </ul><br />
        </p>
    </div>
